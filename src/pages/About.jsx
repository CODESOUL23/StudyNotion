    ...
    <div>
      ...
      <section className="mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white mb-20">
        <div className="grid mx-auto w-[350px] lg:w-fit grid-cols-1 lg:grid-cols-4 mb-12">
          <div className="lg:col-span-2 lg:h-[294px] p-8 bg-richblack-800">
            ...
            <div className="w-fit mt-8">
              <button className="bg-yellow-50 text-richblack-900 font-semibold px-6 py-3 rounded-md">
                Learn More
              </button>
            </div>
          </div>
          <div className="lg:col-span-2 lg:h-[294px] p-8 bg-richblack-900">
            <h1 className="text-richblack-5 text-lg font-semibold">
              Our Teaching Method
            </h1>
            <p className="text-richblack-300 font-medium mt-3">
